...
public abstract class ScalarOptions
{
    ...
    /// <summary>
    /// Gets or sets whether the sidebar links display text should show the method summary (<c>false</c>) or the method path (<c>true</c>).
    /// </summary>
    /// <value>The default value is <c>false</c>.</value>
    public bool SidebarShowPath { get; set; }
